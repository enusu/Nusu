...
module.exports.run = async function({ api, event }) {
  ...
  const botName = global.config.BOTNAME || "✦𝐄𝐛𝐫𝐚𝐡𝐢𝐦 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭✦";

 
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    await api.changeNickname(`[ ${botPrefix} ] • ${botName}`, threadID, api.getCurrentUserID());

    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ ✦𝐄𝐛𝐫𝐚𝐡𝐢𝐦 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭✦ এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
★ যেকোনো অভিযোগ অথবা হেল্প এর জন্য এডমিন ᎬᏴᎡᎪᎻᏆᎷ ᎪᎻᎪᎷᎬᎠ কে নক করতে পারেন ★
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://m.me/ebrahim.ahamed.94849
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://www.whatsapp.com/business/

❖⋆═══════════════════════⋆❖
𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ ✦𝐄𝐛𝐫𝐚𝐡𝐢𝐦 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭✦`;
